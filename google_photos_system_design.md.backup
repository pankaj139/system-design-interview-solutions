...
- [4. DATABASE DESIGN](#4-database-design)
  - [User Database (PostgreSQL)](#user-database-postgresql---relational)
  - [Photo Metadata Database (Cassandra)](#photo-metadata-database-cassandra---wide-column)
  - [Album Database (PostgreSQL)](#album-database-postgresql---relational)
  - [Face Recognition Database (Vector DB)](#face-recognition-database-milvus---vector-database)
...
- [6. DEEP DIVE - UPLOAD FLOW](#6-deep-dive---upload-flow)
  ...
  - [Chunked Upload Process](#chunked-upload-process)
...
- [9. DEEP DIVE - SEARCH](#9-deep-dive---search)
  ...
  - [Vector Search for Faces](#vector-search-for-faces)
...
- [13. TRADE-OFFS](#13-trade-offs)
  - [Storage Trade-Offs](#storage-trade-offs)
  - [Processing Trade-Offs](#processing-trade-offs)
