...
- [RATE LIMITER FOR API GATEWAY](#rate-limiter-for-api-gateway)
  ...
  - [DATABASE DESIGN](#database-design)
    - [API Key Metadata Table (PostgreSQL)](#api-key-metadata-table-postgresql)
      - [Table: api_keys](#table-apikeys)
      - [Table: users](#table-users)
    - [Redis Data Structures](#redis-data-structures)
  - [API DESIGN](#api-design)
    - [Base Configuration](#base-configuration)
    - [Endpoints](#endpoints)
      - [1. Rate Limit Status Check](#1-rate-limit-status-check)
      - [2. Rate Limit Detailed History](#2-rate-limit-detailed-history)
      - [3. Protected API Endpoint (Example)](#3-protected-api-endpoint-example)
      - [4. Upgrade Tier Request](#4-upgrade-tier-request)
  ...
  - [DEEP-DIVE: RATE LIMITING ALGORITHMS](#deep-dive-rate-limiting-algorithms)
    - [Algorithm Comparison](#algorithm-comparison)
      ...
      - [4. Sliding Window Counter (Hybrid)](#4-sliding-window-counter-hybrid)
      - [5. Leaky Bucket Algorithm](#5-leaky-bucket-algorithm)
    - [Algorithm Selection for Our System](#algorithm-selection-for-our-system)
      - [Choice: Sliding Window Counter](#choice-sliding-window-counter)
  - [DEEP-DIVE: DISTRIBUTED SYNCHRONIZATION](#deep-dive-distributed-synchronization)
    - [Challenge: Multi-Region Consistency](#challenge-multi-region-consistency)
    - [Synchronization Strategies](#synchronization-strategies)
      - [Strategy 1: Centralized Counter (Eliminated)](#strategy-1-centralized-counter-eliminated)
      - [Strategy 2: Regional Counters with Synchronous Coordination](#strategy-2-regional-counters-with-synchronous-coordination)
      - [Strategy 3: Regional Counters with Asynchronous Sync (Our Choice)](#strategy-3-regional-counters-with-asynchronous-sync-our-choice)
      - [Strategy 4: Reserved Quota Allocation](#strategy-4-reserved-quota-allocation)
    - [Synchronization Implementation Details](#synchronization-implementation-details)
- [Kafka Topic Configuration](#kafka-topic-configuration)
- [Consumer Group per Region](#consumer-group-per-region)
    - [Handling Network Partitions](#handling-network-partitions)
  - [TRADE-OFFS ANALYSIS](#trade-offs-analysis)
    - [Decision 1: Algorithm Selection](#decision-1-algorithm-selection)
    - [Decision 2: Distributed Architecture](#decision-2-distributed-architecture)
    - [Decision 3: Storage Technology](#decision-3-storage-technology)
    - [Decision 4: API Design Pattern](#decision-4-api-design-pattern)
    - [Decision 5: Consistency vs Availability (CAP Theorem)](#decision-5-consistency-vs-availability-cap-theorem)
    - [Decision 6: Caching Strategy](#decision-6-caching-strategy)
    - [Decision 7: Handling Enterprise Tier (Unlimited)](#decision-7-handling-enterprise-tier-unlimited)
    - [Decision 8: Synchronous vs Asynchronous Logging](#decision-8-synchronous-vs-asynchronous-logging)
  - [CACHING STRATEGY](#caching-strategy)
    - [What to Cache](#what-to-cache)
      - [1. API Key Metadata (L1 + L2 Cache)](#1-api-key-metadata-l1-l2-cache)
      - [2. Rate Limit Counters (Redis Only)](#2-rate-limit-counters-redis-only)
      - [3. Shadow Counters (Redis Only)](#3-shadow-counters-redis-only)
    - [What NOT to Cache](#what-not-to-cache)
      - [1. Individual Request Logs](#1-individual-request-logs)
      - [2. Rate Limit Decisions (Allow/Deny)](#2-rate-limit-decisions-allowdeny)
      - [3. Real-time Usage Statistics](#3-real-time-usage-statistics)
    - [Cache Invalidation Strategy](#cache-invalidation-strategy)
    - [Cache Sizing](#cache-sizing)
  - [BOTTLENECKS & IMPROVEMENTS](#bottlenecks-improvements)
    - [Potential Bottlenecks](#potential-bottlenecks)
      - [Bottleneck 1: Redis Single Point of Failure](#bottleneck-1-redis-single-point-of-failure)
      - [Bottleneck 2: Cross-Region Sync Lag](#bottleneck-2-cross-region-sync-lag)
      - [Bottleneck 3: Database Write Contention for Analytics](#bottleneck-3-database-write-contention-for-analytics)
      - [Bottleneck 4: Hot API Keys](#bottleneck-4-hot-api-keys)
      - [Bottleneck 5: Network Latency Between Services](#bottleneck-5-network-latency-between-services)
    - [Scalability Improvements](#scalability-improvements)
      - [1. Geographic Distribution Enhancement](#1-geographic-distribution-enhancement)
      - [2. Intelligent Tier Prediction](#2-intelligent-tier-prediction)
      - [3. Per-Endpoint Rate Limiting](#3-per-endpoint-rate-limiting)
      - [4. Real-Time WebSocket Updates](#4-real-time-websocket-updates)
    - [Monitoring and Observability](#monitoring-and-observability)
    - [Security Considerations](#security-considerations)
      - [1. API Key Protection](#1-api-key-protection)
      - [2. Rate Limit Bypass Protection](#2-rate-limit-bypass-protection)
    ...
    - [Future Enhancements](#future-enhancements)
      ...
      - [2. Dynamic Rate Limiting](#2-dynamic-rate-limiting)
      - [3. Rate Limit Token Economy](#3-rate-limit-token-economy)
      - [4. GraphQL Support](#4-graphql-support)
      - [5. Rate Limit Marketplace](#5-rate-limit-marketplace)
