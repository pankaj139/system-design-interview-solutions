...
- [GOOGLE PHOTOS SYSTEM DESIGN](#google-photos-system-design)
  - [Cloud-Based Photo Storage and Management Platform](#cloud-based-photo-storage-and-management-platform)
  ...
  - [4. DATABASE DESIGN](#4-database-design)
    - [User Database (PostgreSQL - Relational)](#user-database-postgresql-relational)
    - [Metadata Database (Cassandra - NoSQL)](#metadata-database-cassandra-nosql)
    - [Search Index (Elasticsearch)](#search-index-elasticsearch)
    - [Face and People Database (PostgreSQL)](#face-and-people-database-postgresql)
    - [Vector Database (Milvus/Pinecone)](#vector-database-milvuspinecone)
- [Find similar faces](#find-similar-faces)
  ...
  - [5. API DESIGN](#5-api-design)
    ...
    - [Photo Management Endpoints](#photo-management-endpoints)
      - [5. Upload Photo](#5-upload-photo)
      - [6. Get Photo Details](#6-get-photo-details)
      - [7. Get User Photos](#7-get-user-photos)
      - [8. Update Photo](#8-update-photo)
      - [9. Delete Photo](#9-delete-photo)
      - [10. Batch Upload Photos](#10-batch-upload-photos)
      - [11. Get Batch Upload Status](#11-get-batch-upload-status)
    - [Search Endpoints](#search-endpoints)
      - [12. Search Photos](#12-search-photos)
      - [13. Search by Location](#13-search-by-location)
    - [Album Management Endpoints](#album-management-endpoints)
      - [14. Create Album](#14-create-album)
      - [15. Get Album Details](#15-get-album-details)
      - [16. Add Photos to Album](#16-add-photos-to-album)
      - [17. Remove Photos from Album](#17-remove-photos-from-album)
      - [18. Get User Albums](#18-get-user-albums)
      - [19. Update Album](#19-update-album)
      - [20. Delete Album](#20-delete-album)
    - [Sharing Endpoints](#sharing-endpoints)
      - [21. Create Share Link](#21-create-share-link)
      - [22. Share with Specific User](#22-share-with-specific-user)
      - [23. Get Shared Resource](#23-get-shared-resource)
      - [24. Revoke Share](#24-revoke-share)
      - [25. List My Shares](#25-list-my-shares)
    - [User Profile Endpoints](#user-profile-endpoints)
      - [26. Get User Profile](#26-get-user-profile)
      - [27. Update User Profile](#27-update-user-profile)
      - [28. Get Storage Statistics](#28-get-storage-statistics)
    - [People & Face Management Endpoints](#people-face-management-endpoints)
      - [29. Get People (Face Groups)](#29-get-people-face-groups)
      - [30. Get Person Details](#30-get-person-details)
      - [31. Name a Person](#31-name-a-person)
      - [32. Get Photos by Person](#32-get-photos-by-person)
      - [33. Merge People](#33-merge-people)
      - [34. Remove Face from Person](#34-remove-face-from-person)
      - [35. Search Photos by Face](#35-search-photos-by-face)
      - [36. Hide Person](#36-hide-person)
      - [37. Get Face Detection Status](#37-get-face-detection-status)
      - [38. Tag Person in Photo](#38-tag-person-in-photo)
  ...
  - [6. DEEP-DIVE COMPONENTS & TRADE-OFFS](#6-deep-dive-components-trade-offs)
    - [6.1 Face Recognition Pipeline](#61-face-recognition-pipeline)
    - [6.2 Upload Service Architecture](#62-upload-service-architecture)
    - [6.2 Image Processing Pipeline](#62-image-processing-pipeline)
    - [6.3 Search Service](#63-search-service)
    - [6.4 Storage Tiering Strategy](#64-storage-tiering-strategy)
    - [6.5 Caching Strategy](#65-caching-strategy)
    - [6.6 Key Trade-Offs Analysis](#66-key-trade-offs-analysis)
  - [7. BOTTLENECKS & IMPROVEMENTS](#7-bottlenecks-improvements)
    - [7.1 Potential Bottlenecks](#71-potential-bottlenecks)
    - [7.2 Scalability Improvements](#72-scalability-improvements)
    - [7.3 Monitoring and Observability](#73-monitoring-and-observability)
    - [7.4 Security Considerations](#74-security-considerations)
    - [7.5 Future Enhancements](#75-future-enhancements)
