...
- [LEETCODE SYSTEM DESIGN](#leetcode-system-design)
  - [Online Coding Platform with Judge System](#online-coding-platform-with-judge-system)
  ...
  - [RULE 4: DEEP-DIVE INTO DETAILS](#rule-4-deep-dive-into-details)
    - [Database Design](#database-design)
      - [Users Table](#users-table)
      - [Problems Table](#problems-table)
      - [Problem_Tags Table (Many-to-Many)](#problemtags-table-many-to-many)
      - [Tags Table](#tags-table)
      - [Submissions Table](#submissions-table)
      - [Test_Cases Table](#testcases-table)
      - [User_Problem_Status Table](#userproblemstatus-table)
      - [User_Statistics Table](#userstatistics-table)
      - [Sessions Table (Could use Redis, but showing SQL structure)](#sessions-table-could-use-redis-but-showing-sql-structure)
    - [API Design](#api-design)
      - [Base Configuration](#base-configuration)
      - [Authentication Endpoints](#authentication-endpoints)
      - [Problem Endpoints](#problem-endpoints)
      - [(Optional, for personalized status)](#optional-for-personalized-status)
    ...
    - [Component Deep-Dive](#component-deep-dive)
      - [1. Judge Worker System (Most Critical Component)](#1-judge-worker-system-most-critical-component)
      - [2. Caching Strategy](#2-caching-strategy)
    - [Trade-Offs Analysis](#trade-offs-analysis)
  - [RULE 5: BOTTLENECKS & IMPROVEMENTS](#rule-5-bottlenecks-improvements)
    - [Potential Bottlenecks](#potential-bottlenecks)
      - [1. Judge Worker Capacity](#1-judge-worker-capacity)
      - [2. Database Write Contention (Submissions Table)](#2-database-write-contention-submissions-table)
      - [3. Cache Stampede on Popular Problems](#3-cache-stampede-on-popular-problems)
      - [4. S3 Bandwidth Limitations](#4-s3-bandwidth-limitations)
      - [5. Single Point of Failure - Message Queue](#5-single-point-of-failure-message-queue)
    - [Scalability Improvements](#scalability-improvements)
      - [1. Geographic Distribution](#1-geographic-distribution)
      - [2. CDN for Static Assets](#2-cdn-for-static-assets)
      - [3. Database Query Optimization](#3-database-query-optimization)
      - [4. Real-Time Features with WebSocket](#4-real-time-features-with-websocket)
      - [5. Advanced Caching with Redis Cluster](#5-advanced-caching-with-redis-cluster)
    - [Monitoring and Observability](#monitoring-and-observability)
      - [Metrics to Track](#metrics-to-track)
      - [Alerting Strategy](#alerting-strategy)
    - [Security Considerations](#security-considerations)
      - [1. Code Execution Security](#1-code-execution-security)
      - [2. API Security](#2-api-security)
      - [3. Data Security](#3-data-security)
      - [4. DDoS Protection](#4-ddos-protection)
      - [5. Secure Sandbox Isolation](#5-secure-sandbox-isolation)
